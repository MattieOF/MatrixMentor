...
#define MM_TRACE_NO_NEWLINE(format, ...)       s_MatrixMentorLogger->trace(format __VA_OPT__(,) __VA_ARGS__)
#define MM_INFO_NO_NEWLINE(format, ...)        s_MatrixMentorLogger->info(format __VA_OPT__(,) __VA_ARGS__)
#define MM_WARN_NO_NEWLINE(format, ...)        s_MatrixMentorLogger->warn(format __VA_OPT__(,) __VA_ARGS__)
#define MM_ERROR_NO_NEWLINE(format, ...)       s_MatrixMentorLogger->error(format __VA_OPT__(,) __VA_ARGS__)
#define MM_CRITICAL_NO_NEWLINE(format, ...)    s_MatrixMentorLogger->critical(format __VA_OPT__(,) __VA_ARGS__)
#else
	#define MM_TRACE(...)      
	#define MM_INFO(...)       
	#define MM_WARN(...)       
